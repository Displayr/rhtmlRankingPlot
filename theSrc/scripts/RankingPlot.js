...
class RankingPlot extends RhtmlSvgWidget {
  ...
  _redraw() {
    ...
    let testData = [
        {r: 'Strongly disagree', c: 0, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 1, color: 'green', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 2, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 3, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 4, color: 'brown', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 5, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 6, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 7, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 8, color: 'green', text: 'I am a free spirit.'},
        {r: 'Strongly disagree', c: 9, color: 'red', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 0, color: 'green', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 1, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 2, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 3, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 4, color: 'brown', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 5, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 6, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 7, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 8, color: 'green', text: 'I am a free spirit.'},
        {r: 'Somewhat disagree', c: 9, color: 'red', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 0, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 1, color: 'green', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 2, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 3, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 4, color: 'brown', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 5, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 6, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 7, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 8, color: 'green', text: 'I am a free spirit.'},
        {r: 'Neither agree or disagree', c: 9, color: 'red', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 0, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 1, color: 'green', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 2, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 3, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 4, color: 'brown', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 5, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 6, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 7, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 8, color: 'green', text: 'I am a free spirit.'},
        {r: 'Somewhat agree', c: 9, color: 'red', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 0, color: 'green', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 1, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 2, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 3, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 4, color: 'brown', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 5, color: 'blue', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 6, color: 'purple', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 7, color: 'yellow', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 8, color: 'green', text: 'I am a free spirit.'},
        {r: 'Strongly agree', c: 9, color: 'red', text: 'I am a free spirit.'},
        ];
...
//     }
  ...
  _updateBars(data) {
    let barsSvg = this.outerSvg.selectAll('.bar')
        ...
        .attr('class', 'bar')
        .attr('transform', (d) => {
          let pos = this._itemPosition(d.r, d.c);
