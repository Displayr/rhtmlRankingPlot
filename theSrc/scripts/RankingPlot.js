...
class RankingPlot extends RhtmlSvgWidget {
  ...
  _redraw() {
    ...
    let testData = [
        ...
        {c: 'Strongly disagree', r: 4, color: 'brown', text: 'I am a free spirit.'},
        {c: 'Strongly disagree', r: 5, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Strongly disagree', r: 6, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Strongly disagree', r: 7, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Strongly disagree', r: 8, color: 'green', text: 'I am a free spirit.'},
        {c: 'Strongly disagree', r: 9, color: 'red', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 0, color: 'green', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 1, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 2, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 3, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 4, color: 'brown', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 5, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 6, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 7, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 8, color: 'green', text: 'I am a free spirit.'},
        {c: 'Somewhat disagree', r: 9, color: 'red', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 0, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 1, color: 'green', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 2, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 3, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 4, color: 'brown', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 5, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 6, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 7, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 8, color: 'green', text: 'I am a free spirit.'},
        {c: 'Neither agree or disagree', r: 9, color: 'red', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 0, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 1, color: 'green', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 2, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 3, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 4, color: 'brown', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 5, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 6, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 7, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 8, color: 'green', text: 'I am a free spirit.'},
        {c: 'Somewhat agree', r: 9, color: 'red', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 0, color: 'green', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 1, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 2, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 3, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 4, color: 'brown', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 5, color: 'blue', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 6, color: 'purple', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 7, color: 'yellow', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 8, color: 'green', text: 'I am a free spirit.'},
        {c: 'Strongly agree', r: 9, color: 'red', text: 'I am a free spirit.'},
        ];
...
//     }
  ...
  _updateBars(data) {
    let barsSvg = this.outerSvg.selectAll('.bar')
        ...
        .attr('class', 'bar')
        .attr('transform', (d) => {
          let pos = this._itemPosition(d.c, d.r);
